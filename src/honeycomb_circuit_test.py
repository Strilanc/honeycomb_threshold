...
def test_circuit_details():
    assert generate_honeycomb_circuit(
        ...
        DEPOLARIZE2(0.001) 20 0 7 8 3 14 11 17 24 23 28 29
        DEPOLARIZE1(0.001) 1 2 4 5 6 9 10 12 13 15 16 18 19 21 22 25 26 27
        TICK

        CX 5 0 9 8 13 14 26 17 22 23 18 29
        DEPOLARIZE2(0.001) 5 0 9 8 13 14 26 17 22 23 18 29
        DEPOLARIZE1(0.001) 1 2 3 4 6 7 10 11 12 15 16 19 20 21 24 25 27 28
        TICK
        ...
        DEPOLARIZE2(0.001) 28 2 3 4 11 10 7 16 20 19 24 25
        DEPOLARIZE1(0.001) 0 1 5 6 8 9 12 13 14 15 17 18 21 22 23 26 27 29
        TICK

        CX 13 2 5 4 9 10 22 16 18 19 26 25
        DEPOLARIZE2(0.001) 13 2 5 4 9 10 22 16 18 19 26 25
        DEPOLARIZE1(0.001) 0 1 3 6 7 8 11 12 14 15 17 20 21 23 24 27 28 29
        TICK
